...
app.layout = html.Div([
    ...
    html.H1(children='BRAIN TUMOR DETECTION AND CLASSIFIER', style={'textAlign': 'center'
        }),
    
    
    dcc.Markdown('''
                ###### Step 1: Select an image and upload in the section below.
                ###### Step 2: Wait for the predictions to be displayed!!! 
    '''),
    ...
    html.Div(id='prediction2', style={'position':'absolute', 'left':'800px', 'top':'380px', 'font-size': 'x-large'}),
    
    html.Div(id='facts', style={'position':'absolute', 'left':'800px', 'top':'480px', 'font-size': 'large',\
...
def update_output(list_of_contents):        
    ...
    if list_of_contents is not None:
        ...
        pred=str(round(answ[0][classification]*100 ,3)) + '% chance of having ' + names(classification)   
        ...
        if classification==0:
            ...
            pred2 = 'There is a ' + no_tumor + '% chance of not having any tumor'
